...
with col1:
    ...
    if os.path.exists(profile_image_path):
        ...
        st.warning("Letakkan foto Anda di folder 'Assets' dengan nama 'Profile.jpg'")
...
# Membuat 2 kolom untuk Dospem 1 dan Dospem 2
col_dospem1, col_dospem2 = st.columns(2)

with col_dospem1:
    st.subheader("Pembimbing Utama")
    st.write("**Teny Handhayani, S.Kom., M.Kom., Ph.D.**")
    st.write("Email: tenyh@fti.untar.ac.id")

with col_dospem2:
    st.subheader("Pembimbing Pendamping")
    st.write("**Irvan Lewenusa, S.Kom., M.Kom.**")
    st.write("Email: irvanl@fti.untar.ac.id")
